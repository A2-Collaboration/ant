...
if [ -f $CACHE_REV ]; then
    ...
    export CPLUS_INCLUDE_PATH=$CACHE/gcc/include/c++/4.9.2:$CPLUS_INCLUDE_PATH
    ...
    # Get GCC 4.9.2
    wget https://github.com/Viq111/travis-container-packets/releases/download/gcc-4.9.2/gcc.tar.bz2 -O $CACHE/gcc.tar.bz2
