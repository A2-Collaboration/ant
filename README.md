...
## Troubleshooting
  ...
  * If you are using ROOT6 and run into some issues mainly related to derived classes, please have a look at the [FAQ in the Wiki](https://github.com/A2-Collaboration/ant/wiki/FAQ#known-problems-with-root6) and see if you're problem is known already and if there's some way to avoid it.
