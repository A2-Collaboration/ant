...
Setup_2019_01::Setup_2019_01(const string& name, OptionsPtr opt) :
    Setup(name, opt),
...
void Setup_2019_01::BuildMappings(std::vector<ant::UnpackerAcquConfig::hit_mapping_t>& hit_mappings, std::vector<ant::UnpackerAcquConfig::scaler_mapping_t>& scaler_mappings) const
{
...
Setup_traits::candidatebuilder_config_t Setup_2019_01::GetCandidateBuilderConfig() const
{
...
Setup_traits::triggersimu_config_t Setup_2019_01::GetTriggerSimuConfig() const
{
...
Setup_traits::target_properties_t Setup_2019_01::GetTargetProperties() const
{
...
ant::UnpackerA2GeantConfig::promptrandom_config_t Setup_2019_01::GetPromptRandomConfig() const {
...
AUTO_REGISTER_SETUP(Setup_2019_01)
