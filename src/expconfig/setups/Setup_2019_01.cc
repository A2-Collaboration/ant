...
/**
 * @brief Ant Setup for the January 2019 beamtime using the new Tagger+Yoke
 */
class Setup_2019_01 : public Setup_2017Plus_NewTagger_Base
{
protected:
...
public:
    ...
    Setup_2019_01(const string& name, OptionsPtr opt) :
