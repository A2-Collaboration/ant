...
/**
 * @brief Ant Setup for the July 2019 beamtime using the new Tagger+Yoke. FOR SURE NOT ADJUSTED FOR BEAMTIME SPECS
 */

Setup_2019_07::Setup_2019_07(const string& name, OptionsPtr opt) :
    Setup(name, opt),
    ...
    TAPSVeto(make_shared<detector::TAPSVeto_2019>(cherenkovInstalled, pizzaInstalled))
{
    ...
    TAPS->SetElementFlag(Detector_t::ElementFlag_t::Broken, {14,114,137,337}); //And two more
    ...
    SetTimeRange("2019-07-16", "2019-08-05");
}
...
void Setup_2019_07::BuildMappings(std::vector<ant::UnpackerAcquConfig::hit_mapping_t>& hit_mappings, std::vector<ant::UnpackerAcquConfig::scaler_mapping_t>& scaler_mappings) const
{
...
AUTO_REGISTER_SETUP(Setup_2019_07)
