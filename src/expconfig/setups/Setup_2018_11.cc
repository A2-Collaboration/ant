...
/**
 * @brief Ant Setup for the December 2018 beamtime using the new Tagger+Yoke
 */
class Setup_2018_11 : public Setup_2017Plus_NewTagger_Base
{
protected:
    const std::shared_ptr<detector::Tagger_2018_11> Tagger;

public:

    Setup_2018_11(const string& name, OptionsPtr opt) :
