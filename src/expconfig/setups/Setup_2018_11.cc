...
/**
 * @brief Ant Setup for the December 2018 beamtime using the new Tagger+Yoke. FOR SURE NOT ADJUSTED FOR BEAMTIME SPECS
 */
Setup_2018_11::Setup_2018_11(const string& name, OptionsPtr opt) :
    Setup(name, opt),
    MCTaggerHits(opt->Get<bool>("MCTaggerHits",false)),
    cherenkovInstalled(false),
    pizzaInstalled(true),
    Trigger(make_shared<detector::Trigger_2014>()),
    Tagger(make_shared<detector::Tagger_2018_11>()),
...
void Setup_2018_11::BuildMappings(std::vector<ant::UnpackerAcquConfig::hit_mapping_t>& hit_mappings, std::vector<ant::UnpackerAcquConfig::scaler_mapping_t>& scaler_mappings) const
{
...
Setup_traits::candidatebuilder_config_t Setup_2018_11::GetCandidateBuilderConfig() const
{
...
Setup_traits::triggersimu_config_t Setup_2018_11::GetTriggerSimuConfig() const
{
...
Setup_traits::target_properties_t Setup_2018_11::GetTargetProperties() const
{
...
ant::UnpackerA2GeantConfig::promptrandom_config_t Setup_2018_11::GetPromptRandomConfig() const {
...
AUTO_REGISTER_SETUP(Setup_2018_11)
