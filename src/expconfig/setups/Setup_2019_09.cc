...
/**
 * @brief Ant Setup for the September 2019 beamtime using the new Tagger+Yoke.
 */

Setup_2019_09::Setup_2019_09(const string& name, OptionsPtr opt) :
    Setup(name, opt),
    ...
    TAPSVeto(make_shared<detector::TAPSVeto_2019>(cherenkovInstalled, pizzaInstalled))
{
    ...
    SetTimeRange("2019-09-27", "2019-10-11");
}

double Setup_2019_09::GetElectronBeamEnergy() const {
    return 1604.0;
}

void Setup_2019_09::BuildMappings(std::vector<ant::UnpackerAcquConfig::hit_mapping_t>& hit_mappings, std::vector<ant::UnpackerAcquConfig::scaler_mapping_t>& scaler_mappings) const
{
...
Setup_traits::candidatebuilder_config_t Setup_2019_09::GetCandidateBuilderConfig() const
{
...
Setup_traits::triggersimu_config_t Setup_2019_09::GetTriggerSimuConfig() const
{
...
Setup_traits::target_properties_t Setup_2019_09::GetTargetProperties() const
{
...
ant::UnpackerA2GeantConfig::promptrandom_config_t Setup_2019_09::GetPromptRandomConfig() const {
...
AUTO_REGISTER_SETUP(Setup_2019_09)
