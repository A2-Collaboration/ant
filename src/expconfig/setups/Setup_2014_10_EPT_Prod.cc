...
public:
    ...
    {
        SetTimeRange("2014-10-14", "2014-11-03");
        ...
        TAPS->SetElementFlag(Detector_t::ElementFlag_t::NoCalibFill, {74,76,128,148,303,347,353});
        TAPS->SetElementFlag(Detector_t::ElementFlag_t::NoCalibUseDefault, {149,219,221,226,294,369,373,375});
