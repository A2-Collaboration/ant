...
/**
 * @brief Ant Setup for the October 2021 beamtime
 */

Setup_2021_10::Setup_2021_10(const string& name, OptionsPtr opt) :
    Setup(name, opt),
    ...
    TAPSVeto(make_shared<detector::TAPSVeto_2019>(cherenkovInstalled, pizzaInstalled))
{
    ...
    //No dedicated smearing for 2021_10 exist yet
    ...
    AddPromptRange({-10, 10});
    AddRandomRange({ -100,  -50});
    AddRandomRange({  50,   100});

    SetTimeRange("2021-10-11", "2021-10-14");
}

double Setup_2021_10::GetElectronBeamEnergy() const {
    return 855.0;
}

void Setup_2021_10::BuildMappings(std::vector<ant::UnpackerAcquConfig::hit_mapping_t>& hit_mappings, std::vector<ant::UnpackerAcquConfig::scaler_mapping_t>& scaler_mappings) const
{
...
Setup_traits::candidatebuilder_config_t Setup_2021_10::GetCandidateBuilderConfig() const
{
...
Setup_traits::triggersimu_config_t Setup_2021_10::GetTriggerSimuConfig() const
{
...
AUTO_REGISTER_SETUP(Setup_2021_10)
