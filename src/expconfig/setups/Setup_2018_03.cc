...
/**
 * @brief Ant Setup for the March 2018 beamtime using the new Tagger
 */
class Setup_2018_03 : public Setup_2017Plus_NewTagger_Base
{
protected:
...
public:
    ...
    Setup_2018_03(const string& name, OptionsPtr opt) :
