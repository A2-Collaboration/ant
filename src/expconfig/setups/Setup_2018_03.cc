...
Setup_2018_03::Setup_2018_03(const string& name, OptionsPtr opt) :
    Setup(name, opt),
    ...
    TAPSVeto(make_shared<detector::TAPSVeto_2014>(cherenkovInstalled, pizzaInstalled))
{
    ...
    //No dedicated smearing for 2018_03 exist yet
    ...
    // ECorr, should be applied after MC smearing, no dedicated ECorr for 2018_03 exists yet
...
bool Setup_2018_03::Matches(const ant::TID& tid) const
{
...
double Setup_2018_03::GetElectronBeamEnergy() const {
    return 883.0;
}

void Setup_2018_03::BuildMappings(std::vector<ant::UnpackerAcquConfig::hit_mapping_t>& hit_mappings, std::vector<ant::UnpackerAcquConfig::scaler_mapping_t>& scaler_mappings) const
{
...
Setup_traits::candidatebuilder_config_t Setup_2018_03::GetCandidateBuilderConfig() const
{
...
Setup_traits::triggersimu_config_t Setup_2018_03::GetTriggerSimuConfig() const
{
...
ant::UnpackerA2GeantConfig::promptrandom_config_t Setup_2018_03::GetPromptRandomConfig() const {
...
AUTO_REGISTER_SETUP(Setup_2018_03)
