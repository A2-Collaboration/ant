...
void TAPS_Energy::ThePhysics::ProcessEvent(const Event& event)
{
    ...
    {
        if(cand->Detector & Detector_t::Type_t::TAPS && cand->VetoEnergy < 1.0)
        {
        ...
        else if(cand->Detector & Detector_t::Type_t::CB && cand->VetoEnergy < 0.25)
        {
