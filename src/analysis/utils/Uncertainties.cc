...
UncertaintyModels::MeasuredProton::MeasuredProton(std::shared_ptr<const UncertaintyModel>& base_):
    UncertaintyModel(),
    base(base_)
{
...
UncertaintyModels::MeasuredProton::~MeasuredProton()
{

}

Uncertainties_t UncertaintyModels::MeasuredProton::GetSigmas(const TParticle& particle) const
{
    ...
    if(particle.Type() == ParticleTypeDatabase::Proton) {
        ...
        auto dEovEclCBInit = [] (Double_t Ecl) { // CB dE/E
        ...
        auto dEovEclTAPSInit = [] (Double_t Ecl) { // TAPS dE/E
