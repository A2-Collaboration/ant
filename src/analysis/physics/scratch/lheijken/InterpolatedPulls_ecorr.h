...
class scratch_lheijken_InterpolatedPulls_ecorr : public Physics {
protected:
    ...
    void CandECorr(const TCandidateList &incands, TCandidateList &outcands);

public:
    scratch_lheijken_InterpolatedPulls_ecorr(const std::string& name, OptionsPtr opts);
