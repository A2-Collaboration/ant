...
class PID_TAPSVeto_Kinfit : public Physics {
public:

    struct MultiPi0 {
        MultiPi0(HistogramFactory& histFac, unsigned nPi0, utils::UncertaintyModelPtr FitterModel, bool enableTree = false);
    ...
    protected:
        ...
        TH3* PID_banana      = nullptr;
        TH3* TAPSVeto_banana = nullptr;
...
public:
    PID_TAPSVeto_Kinfit(const std::string& name, OptionsPtr opts);
